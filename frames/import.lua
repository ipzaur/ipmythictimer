...
function Addon:RenderImport()
    ...
    Addon.fImport.caption:SetText("Импорт темы")
    ...
    Addon.fImport.textarea:SetAutoFocus(false)
    ...
    Addon.fImport.textarea:SetScript("OnEscapePressed", function()
        Addon.fImport:Hide()
    end)
    ...
    Addon.fImport.apply:SetText("Импортировать")
    ...
    Addon.fImport.cancel:SetText("Отменить")
