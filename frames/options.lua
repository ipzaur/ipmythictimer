...
function Addon:RenderOptions()
    ...
    Addon.fOptions:SetSize(270, 580)
    ...
    Addon.fOptions.timerCaption:SetSize(180, 20)
    ...
    Addon.fOptions.progressCaption:SetSize(180, 20)
    ...
    -- Rename dungeons button
    top = top - 48
    Addon.fOptions.cleanDB = CreateFrame("Button", nil, Addon.fOptions.common, "IPButton")
    Addon.fOptions.cleanDB:SetPoint("CENTER", Addon.fOptions.common, "TOP", 0, top)
    Addon.fOptions.cleanDB:SetSize(230, 30)
    Addon.fOptions.cleanDB:SetText(Addon.localization.RNMKEYSBT)
    Addon.fOptions.cleanDB:SetScript("OnClick", function(self)
        Addon:ToggleKeyRename()
    end)
    Addon.fOptions.cleanDB:HookScript("OnEnter", function(self, event, ...)
        Addon:ToggleKeyRenameTooltip(self, true)
    end)
    Addon.fOptions.cleanDB:HookScript("OnLeave", function(self, event, ...)
        Addon:ToggleKeyRenameTooltip(self, false)
    end)
